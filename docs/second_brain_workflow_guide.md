...
### 1. Deploy a build with the 39-tool MCP surface
...
**Verify**: ask your agent to list NexWiki's tools — you should see **39**, including `get_context_overview` and `get_recent_activity`.
...
* [MCP Server Guide](./mcp_server.md) — all 39 tools in detail, client connection configs
