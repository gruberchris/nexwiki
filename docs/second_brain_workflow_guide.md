...
### 1. Deploy a build with the 38-tool MCP surface
...
**Verify**: ask your agent to list NexWiki's tools — you should see **38**, including `get_context_overview` and `get_recent_activity`.
...
* [MCP Server Guide](./mcp_server.md) — all 38 tools in detail, client connection configs
