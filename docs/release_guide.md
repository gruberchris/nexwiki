...
* Verify that the total MCP tool count stated across documentation (`README.md`, `AGENTS.md`, `docs/README.md`, `docs/mcp_server.md`) remains strictly accurate (**37 tools**).
