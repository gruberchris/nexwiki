...
Restart Claude Desktop, and you will see the **hammer icon 🔨** in the chat window, confirming that all thirty-seven NexWiki MCP tools are ready to use!
...
Cursor will establish a stream connection and immediately list all thirty-seven NexWiki tools in the sidebar. You can now use Cursor Composer or chat (`Cmd+K` / `Ctrl+K`) and reference your wiki directly during code generation!
