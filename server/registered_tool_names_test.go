...
// still defined as dead handlers, while get_backlinks was removed outright (read_article lists
// every backlink, and delete_article refuses while any exist unless break_links is true). An
