...
|  | What it means |
|---|---|
| 🤖 **MCP-native, not bolted on** | 28 tools over stdio and Streamable HTTP, serving both the current `2026-07-28` protocol revision and older clients. The data model was designed around the agent, not adapted for it. |
